export const howItWorks = {
  ...
  steps: {
    ...
    items: [
      ...
      { title: "Choose your Munk", body: "You pick the tutor. If the fit is not right after the first session, we will match you again at no cost." },
      { title: "Book your sessions", body: "Choose a weekly time, at home or at our Oran Park centre, 1-to-1 or in a small group." },
      { title: "Start learning in person", body: "Sessions begin with the current school work. You receive written notes after each one." },
    ],
  },
  delivery: {

export const hscMathsAdvanced = {
  ...
  modules: {
    ...
    items: [
      ...
      { title: "Trigonometric Functions", body: "Radians, graphs, identities and trigonometric equations." },
      { title: "Calculus", body: "Rates of change, differentiation rules, integration and applications." },
      { title: "Exponential and Logarithmic Functions", body: "Laws, graphs, calculus of exponentials and logarithms." },
      { title: "Statistical Analysis", body: "Bivariate data, random variables and the normal distribution." },
      { title: "Financial Mathematics", body: "Series, annuities and loan repayment problems." },
    ],
  },
  tutorPitch: {
    eyebrow: "Your tutor",
    ...
    points: [
      ...
      "Current syllabus and past HSC papers",
      "Marks work using NESA marking guidelines",

...
export const home = {
  title: "In-Person Tutoring Across Suburban Sydney | TutorMunk",
  metaDescription:
    "TutorMunk provides face-to-face K-12 tutoring across suburban Sydney, never online. A tutor comes to your home, or visit our Gregory Hills centre.",
  hero: {
    eyebrow: "In-home and centre based, K to Year 12",
    heading: "Tutoring that happens in the room, not on a screen.",
    body: "TutorMunk is an in-person tutoring company for K-12 students across suburban Sydney: in-home sessions or our Gregory Hills centre, never online. We match your child with a tutor who teaches face to face, follows the NESA syllabus and reports back to you every term.",
    ...
    items: [
      {
        ...
        body: "A short call about year, subjects and goals.",
      },
      {
        title: "We match you with the right Munks",
        body: "We shortlist tutors by subject, stage and suburb.",
      },
      { title: "Choose your Munk", body: "Read profiles, then pick the tutor you prefer." },
      { title: "Book your sessions", body: "Set a weekly time at home or at the centre." },
      {
        title: "Start learning in person",
        body: "Face to face sessions with written notes after each one.",
      },
    ],
  ...
  reviewsSection: {
    ...
    body: "Scroll through reviews from families across South-West Sydney.",
  },
  suburbsSection: {

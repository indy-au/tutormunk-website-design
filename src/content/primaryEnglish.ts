export const primaryEnglish = {
  ...
  whatWeCover: {
    ...
    items: [
      ...
      { title: "Spelling and vocabulary", body: "Word patterns, prefixes and suffixes, plus a weekly word list." },
      { title: "Narrative writing", body: "Planning, character, setting and a clear beginning, middle and end." },
      { title: "Persuasive writing", body: "Position statements, reasons, evidence and a firm conclusion." },
      { title: "Speaking and listening", body: "Short presentations and note taking for class tasks." },
    ],
  },
  howSessions: {
    ...
    steps: [
      ...
      { title: "Skill focus (20 minutes)", body: "One grammar or writing skill, taught with examples." },
      { title: "Writing (10 minutes)", body: "A short piece using the skill just taught." },
      { title: "Wrap up (5 minutes)", body: "Home practice set and a note written for parents." },
    ],
  },
  faq: {
    eyebrow: "FAQ",

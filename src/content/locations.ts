export const locations = {
  ...
  suburbGrid: {
    ...
    items: [
      ...
      { name: "Gregory Hills", to: "/locations/oran-park" },
      { name: "Leppington", to: "/locations/oran-park" },
      { name: "Gledswood Hills", to: "/locations/oran-park" },
      { name: "Kirkham", to: "/locations/oran-park" },
      { name: "Narellan", to: "/locations/oran-park" },
      { name: "Catherine Field", to: "/locations/oran-park" },
      { name: "Harrington Park", to: "/locations/oran-park" },
    ],
  },
  cta: {
...
export const suburbOranPark = {
  title: "Tutoring in Oran Park, K-12 In-Person | TutorMunk",
  metaDescription:
  ...
  whatWeCover: {
    ...
    items: [
      ...
      { title: "Local schools", body: "Students come from the local primary and high schools in the Oran Park area." },
      { title: "Exam prep", body: "Selective, OC, NAPLAN, ICAS and HSC Sprint programs run at the centre." },
      { title: "Times", body: "Weekday afternoons and evenings, plus Saturday mornings." },
      { title: "Travel", body: "No travel fee for Oran Park home visits." },
    ],
  },
  reviewsSection: {
